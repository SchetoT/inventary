...
import logger from "../../utils/logger.js"; // Asegúrate de tener un archivo de logger configurado
...
export const createItem = async (req, res) => {
  ...
  try {
    ...
    // Registro del error en caso de fallo
    logger.error(`Error al crear el ítem: ${error.message}`, {
      stack: error.stack,
      data: req.body, // Información adicional (opcional)
    });
